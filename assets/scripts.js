...
overlay.className = "stage__overlay";
document.getElementsByClassName('cart-btn')[0].addEventListener('click', function(){
  document.getElementsByClassName('stage--cart')[0].classList.add('is-open');
});
document.getElementsByClassName('stage__overlay')[0].addEventListener('click', function(){
  document.getElementsByClassName('stage--cart')[0].classList.remove('is-open');
});
